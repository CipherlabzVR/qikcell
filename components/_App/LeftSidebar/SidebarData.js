...
export const getSidebarData = (IsGarmentSystem) => {
    const sidebarData = [
        ...
        },
        {
            ...
            IsAvailable: true,
            subNav: [
                { title: "Calendar", path: "/reservation/inner-calendar", categoryId: 49, isAvailable: true }
            ],
        },
        {
            title: "Master Data",
        ...
        },
        {
            ...
            subNav: [
                ...
                { title: "User Manual", path: "/administrator/user-manual/", categoryId: 150, isAvailable: true },
                ...
                { title: "Hosting Fee", path: "/administrator/company-hosting/", categoryId: 152, isAvailable: true },
                ...
                { title: "Subscription", path: "/administrator/subscription/", categoryId: 151, isAvailable: true },
            ],
        }
    ];
