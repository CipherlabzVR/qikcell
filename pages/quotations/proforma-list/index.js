...
import ProformaInvoiceReport from "@/components/UIElements/Modal/Reports/ProformaInvoiceReport";
                        ...
                        <Table aria-label="simple table" className="dark-table">
                            <TableHead>
                                <TableRow>
                                    ...
                                    {tabValue === 4 ? (
                                        <TableCell align="right">Rejected Reason</TableCell>
                                    ) : tabValue === 3 ? (
                                        null
                                    ) : (
                                                ...
                                                <TableRow key={index}>
                                                    ...
                                                    {tabValue === 4 ? (
                                                        ...
                                                        <TableCell align="right">
                                                            <Box display="flex" gap={1} justifyContent="end" flexWrap="wrap">
                                                                {update && tabValue === 0 ?
